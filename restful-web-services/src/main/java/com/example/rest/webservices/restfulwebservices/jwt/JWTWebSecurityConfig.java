 ...
 * JWTWebSecurityConfig extends WebSecurityConfigurerAdapter {
 * 
 * @Autowired private JwtUnAuthorizedResponseAuthenticationEntryPoint
 * jwtUnAuthorizedResponseAuthenticationEntryPoint;
 * 
 * @Autowired private UserDetailsService jwtInMemoryUserDetailsService;
 * 
 * @Autowired private JwtTokenAuthorizationOncePerRequestFilter
 * jwtAuthenticationTokenFilter;
 * 
 * @Value("${jwt.get.token.uri}") private String authenticationPath;
 * 
 * @Autowired public void configureGlobal(AuthenticationManagerBuilder auth)
 * throws Exception { auth .userDetailsService(jwtInMemoryUserDetailsService)
 ...
 * jwtUnAuthorizedResponseAuthenticationEntryPoint).and()
 ...
 * .antMatchers(HttpMethod.OPTIONS, "/**") .and() .ignoring() .antMatchers(
 * HttpMethod.GET, "/" //Other Stuff You want to Ignore ) .and() .ignoring()
